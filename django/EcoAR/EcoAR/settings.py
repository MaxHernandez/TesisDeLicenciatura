import os
# Django settings for EcoAR project.
...
SECRET_KEY = '9+g87+b6w84hpn5u)eqzgv3aw(!1_kmo-^qhc=+3njh=7iy0b8'
...
ROOT_URLCONF = 'EcoAR.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'EcoAR.wsgi.application'
