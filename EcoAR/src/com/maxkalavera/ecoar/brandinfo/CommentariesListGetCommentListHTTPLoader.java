...
public class CommentariesListGetCommentListHTTPLoader extends HttpRequestLoader  {
	...
	public CommentariesListGetCommentListHTTPLoader(Context context, RequestParamsBundle requestBundle, BrandModel brand, int page) {
		super(context, 
				context.getResources().getString(R.string.webservice) +
				context.getResources().getString(R.string.webservice_brand_commentaries_get),
				GET,
				requestBundle); 
		this.setCookiesOn();
		this.setCSRFOn();
