...
public class ServerBarcodeObtainer {

	public static final String NAME = "SERVER_BARCODE_OBTAINER";
	
	Context context;
	String url;
	
	public ServerBarcodeObtainer(Context context) {
		this.context = context;
		this.url = context.getResources().getString(R.string.webservice) +
				context.getResources().getString(R.string.webservice_search_barcode);
	}
	...
	public ArrayList<ProductModel> getData(String query, int page){
		...
		requestBundle.addUriParam("barcode", query);
